...
/**
 * login form is a component that handles the login form.
 * @param {boolean} isLoading is a boolean that indicates if the form is loading.
 * @param {boolean} success is a boolean that indicates if the form is successful.
 * @param {Function} onSubmit is the submit event callback.
 */
